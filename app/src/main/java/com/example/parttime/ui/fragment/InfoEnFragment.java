...
public class InfoEnFragment extends BaseImmersionFragment {
...
//    Button btnNoDe;
    ...
    public static InfoEnFragment NewInstanse() {
        InfoEnFragment latestNewsFragment = new InfoEnFragment();
    ...
    protected int getLayoutId() {
        return R.layout.fragment_en_info;
    }
...
//            initDate(UserEntity.getSingleton().getUserId());
    ...
    @OnClick({R.id.btn_symmetry, R.id.btn_no_symmetry, R.id.btn_symmetry_en,  R.id.btn_no_symmetry_en,R.id.ll_no_symmetry,R.id.btn_send_msg,R.id.btn_send_msg_no})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_no_symmetry_en: //非对称加密
                ...
                break;
            case R.id.btn_send_msg : //对称发送短线
                String msg = etEn.getText().toString();
            ...
            case R.id.btn_send_msg_no : //非对称发送短线
                String msgNo = etNoEn.getText().toString();
